...
struct TodayClockView: View {
    ...
    private var vm: TodayViewModel {
        ...
        let newViewModel = TodayViewModel(alarmService: alarmService, modelContext: modelContext)
    ...
    var body: some View {
        NavigationStack {
            ScrollView {
                VStack(spacing: 0) {
                    // Clock View
                    ClockView(events: vm.clockEvents)
                    ...
                    VStack(alignment: .leading, spacing: TickerSpacing.md) {
                        ...
                        if !vm.hasUpcomingAlarms {
                            ...
                            LazyVStack(spacing: 0) {
                                ForEach(vm.upcomingAlarms) { presentation in
