...
public protocol TickerScheduleExpanderProtocol {
...
public struct TickerScheduleExpander: TickerScheduleExpanderProtocol {
    ...
    public func expandSchedule(_ schedule: TickerSchedule, within window: DateInterval) -> [Date] {
        switch schedule {
    ...
    public func expandSchedule(_ schedule: TickerSchedule, within48HoursFrom startDate: Date) -> [Date] {
    ...
    public func expandSchedule(_ schedule: TickerSchedule, from startDate: Date, strategy: AlarmGenerationStrategy) -> [Date] {
