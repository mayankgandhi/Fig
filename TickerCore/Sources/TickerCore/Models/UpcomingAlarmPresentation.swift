...
/// View-ready representation of an upcoming alarm with pre-calculated values
public struct UpcomingAlarmPresentation: Identifiable, Equatable, Codable {
    public let id: UUID
    public let baseAlarmId: UUID
    ...
    // Optional metadata
    public let hasCountdown: Bool
    public let tickerDataTitle: String?
    ...
    public init(baseAlarmId: UUID, displayName: String, icon: String, color: Color, nextAlarmTime: Date, scheduleType: ScheduleType, hour: Int, minute: Int, hasCountdown: Bool, tickerDataTitle: String?) {
    ...
    public enum ScheduleType: Equatable, Codable {
        case oneTime
        case daily
