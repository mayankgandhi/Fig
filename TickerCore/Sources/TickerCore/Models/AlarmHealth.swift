...
public struct AlarmHealth: Codable, Equatable {
    /// When alarms were last regenerated
    public var lastRegenerationDate: Date?

    /// Whether the last regeneration was successful
    public var lastRegenerationSuccess: Bool

    /// Number of active (future) alarms currently scheduled
    public var activeAlarmCount: Int
    ...
    public static func healthy(alarmCount: Int) -> AlarmHealth {
        AlarmHealth(
    ...
    public static func failed(previousHealth: AlarmHealth) -> AlarmHealth {
        AlarmHealth(
            lastRegenerationDate: Date(),
    ...
    public static func initial() -> AlarmHealth {
        AlarmHealth(
