...
struct ScheduleView: View {
    ...
    private func repeatOptionButton(for option: ScheduleViewModel.RepeatOption) -> some View {
        Button {
            ...
            // Check if option is a pro feature
            let isProFeature = isProProtectedOption(option)
            
            // If pro feature, check subscription status
            if isProFeature {
                Task {
            ...
            TickerPill(
                ...
                size: .compact,
                isProFeature: isProProtectedOption(option)
            )
    ...
    private func isProProtectedOption(_ option: ScheduleViewModel.RepeatOption) -> Bool {
        switch option {
