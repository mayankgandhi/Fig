...
final class OptionsPillsViewModel {
    ...
    private(set) weak var iconViewModel: IconPickerViewModel?
    ...
    var hasIconValue: Bool {
        // Icon always has a value since there's always a default icon selected
        iconViewModel != nil
    }

    var hasAnyActiveOptions: Bool {
        hasScheduleValue || hasLabelValue || hasCountdownValue || hasSoundValue || hasIconValue
    }
